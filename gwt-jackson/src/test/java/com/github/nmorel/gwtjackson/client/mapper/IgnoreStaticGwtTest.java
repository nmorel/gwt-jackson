 ...
 */
public class IgnoreStaticGwtTest extends GwtJacksonTestCase {

    public interface IgnoreStaticBeanMapper extends ObjectMapper<IgnoreStaticBean>, ObjectMapperTester<IgnoreStaticBean> {
    ...
    public void testSerializeValue() {
        IgnoreStaticTester.INSTANCE.testSerializeValue( IgnoreStaticBeanMapper.INSTANCE );
    }
}
