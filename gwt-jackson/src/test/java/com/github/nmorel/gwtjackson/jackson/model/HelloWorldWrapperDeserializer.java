...
public class HelloWorldWrapperDeserializer extends JsonDeserializer<HelloWorldWrapper> {
    ...
    @Override
    public HelloWorldWrapper deserialize( JsonParser jsonParser, DeserializationContext deserializationContext ) throws IOException, JsonProcessingException {
        return HelloWorldWrapper.fromString(jsonParser.getValueAsString());
    }
}
