...
public class HelloWorldWrapperSerializer extends JsonSerializer<HelloWorldWrapper> {
    ...
    @Override
    public void serialize( HelloWorldWrapper helloWorldWrapper, JsonGenerator jsonGenerator, SerializerProvider serializerProvider )
            throws IOException, JsonProcessingException {
        jsonGenerator.writeString( helloWorldWrapper.toString() );
    }
}
