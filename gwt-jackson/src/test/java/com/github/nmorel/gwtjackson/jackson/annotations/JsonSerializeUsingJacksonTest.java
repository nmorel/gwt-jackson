 ...
 */
public class JsonSerializeUsingJacksonTest extends AbstractJacksonTest {

    @Test
    public void testSerialize() {
        JsonSerializeUsingTester.INSTANCE
                .testSerialize( createWriter( JsonSerializeUsingBean.class ) );
    }
