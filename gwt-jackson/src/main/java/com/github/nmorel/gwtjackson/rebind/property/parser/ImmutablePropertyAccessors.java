 ...
 */
final class ImmutablePropertyAccessors implements PropertyAccessors {
    ...
    ImmutablePropertyAccessors( String propertyName, Optional<JField> field, Optional<JMethod> getter, Optional<JMethod> setter,
