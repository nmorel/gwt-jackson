...
/**
 * Super source for {@link com.fasterxml.jackson.databind.annotation.JsonSerialize} to remove the use of java.lang.reflect.* classes
 *
...
public @interface JsonSerialize
{
     ...
     */
    @SuppressWarnings("rawtypes") // to work around JDK8 bug wrt Class-valued annotation properties
    public Class<?> contentUsing() default Void.class;
     ...
     */
    @SuppressWarnings("rawtypes") // to work around JDK8 bug wrt Class-valued annotation properties
    public Class<?> keyUsing() default Void.class;
     ...
     */
    @SuppressWarnings("rawtypes") // to work around JDK8 bug wrt Class-valued annotation properties
    public Class<?> nullsUsing() default Void.class;
     ...
     */
    @SuppressWarnings("rawtypes") // to work around JDK8 bug wrt Class-valued annotation properties
    public Class<?> contentConverter() default Void.class;
