...
public class JsonWriterTest extends GwtJacksonTestCase
{
  ...
  public void testDoubles() throws IOException
  {
    ...
    if( GWT.isProdMode()){
      ...
      assertEquals("[0,"
        ...
        + "3.141592653589793,"
        + "2.718281828459045]", StringBuilder.toString());
    }else{
      assertEquals("[-0.0,"
        + "1.0,"
  ...
  public void testLongs() throws IOException
  {
    ...
    assertEquals("[0,"
        ...
        + "-1,"
        + "-9223372036854775808,"
        + "9223372036854775807]", StringBuilder.toString());
  }
  ...
  public void testNumbers() throws IOException
  {
    ...
    assertEquals("[0,"
        + "9223372036854775808,"
        + "-9223372036854775809,"
        + "3.141592653589793238462643383]", StringBuilder.toString());
  }
  ...
  public void testObjectsInArrays() throws IOException
  {
    ...
    assertEquals("[{\"a\":5,\"b\":false},"
        + "{\"c\":6,\"d\":true}]", StringBuilder.toString());
  }
  ...
  public void testArraysInObjects() throws IOException
  {
    ...
    assertEquals("{\"a\":[5,false],"
        + "\"b\":[6,true]}", StringBuilder.toString());
  }
