...
public final class ObjectIdDeserializationTester extends AbstractTester
{
    ...
    public void testSimpleDeserializationClass( JsonMapperTester<Identifiable> mapper )
    {
        // then bring back...
    ...
    public void testSimpleDeserializationProperty( JsonMapperTester<IdWrapper> mapper )
    {
    ...
    public void testSimpleDeserWithForwardRefs( JsonMapperTester<IdWrapper> mapper )
    {
    ...
    public void testCustomDeserializationClass( JsonMapperTester<IdentifiableCustom> mapper )
    {
        // then bring back...
    ...
    public void testCustomDeserializationProperty( JsonMapperTester<IdWrapperExt> mapper )
    {
        // then bring back...
