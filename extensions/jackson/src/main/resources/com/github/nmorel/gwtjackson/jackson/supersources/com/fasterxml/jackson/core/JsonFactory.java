        ...
        java.io.Serializable // since 2.1 (for Android, mostly)
{
    ...
    private final static SerializableString DEFAULT_ROOT_VALUE_SEPARATOR =
     ...
     */
    final protected static ThreadLocal<SoftReference<BufferRecycler>> _recyclerRef = new ThreadLocal<SoftReference<
            BufferRecycler>>();
    ...
    protected JsonParser _createParser(DataInput input, IOContext ctxt) throws IOException {
        ...
        if (format != FORMAT_NAME_JSON) { // NOTE: only ensure override; full equality NOT needed
            throw new UnsupportedOperationException(StringUtil.format(
