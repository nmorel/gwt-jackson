...
public abstract class TypeDeserializer {
    ...
    public static Object deserializeIfNatural(JsonParser p, DeserializationContext ctxt,
        ...
        switch (t) {
            case VALUE_STRING:
                if (ClassUtils.isAssignableFrom(base, String.class)) {
                    return p.getText();
                }
                break;
            case VALUE_NUMBER_INT:
                if (ClassUtils.isAssignableFrom(base, Integer.class)) {
                    return p.getIntValue();
                }
                break;

            case VALUE_NUMBER_FLOAT:
                if (ClassUtils.isAssignableFrom(base, Double.class)) {
                    return Double.valueOf(p.getDoubleValue());
                }
                break;
            case VALUE_TRUE:
                if (ClassUtils.isAssignableFrom(base, Boolean.class)) {
                    return Boolean.TRUE;
                }
                break;
            case VALUE_FALSE:
