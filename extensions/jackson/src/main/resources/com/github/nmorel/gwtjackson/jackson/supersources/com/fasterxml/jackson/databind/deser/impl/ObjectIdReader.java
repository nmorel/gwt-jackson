...
public class ObjectIdReader
    ...
    protected ObjectIdReader(JavaType t, PropertyName propName, ObjectIdGenerator<?> gen,
            JsonDeserializer<?> deser, ObjectIdResolver resolver) {
        _idType = t;
    ...
    protected ObjectIdReader(JavaType t, PropertyName propName, ObjectIdGenerator<?> gen,
        ...
        this(t, propName, gen, deser, new SimpleObjectIdResolver());
    }
    ...
    public static ObjectIdReader construct(JavaType idType, PropertyName propName,
        ...
        return new ObjectIdReader(idType, propName, generator, deser, resolver);
    }

    @Deprecated // since 2.4
    public static ObjectIdReader construct(JavaType idType, PropertyName propName,
            ObjectIdGenerator<?> generator, JsonDeserializer<?> deser) {
        return construct(idType, propName, generator, deser, new SimpleObjectIdResolver());
    }
