...
public @interface JsonFormat {
    ...
    public static class Features {
        ...
        public String toString() {
            ...
            return StringUtil.format("(enabled=0x%x,disabled=0x%x)", _enabled, _disabled);
        }
    ...
    public static class Value
        ...
        public Value(String p, Shape sh, String localeStr, String tzStr, Features f,
            ...
            this(p, sh,
                    (Locale) null,
                    (tzStr == null || tzStr.length() == 0 || DEFAULT_TIMEZONE.equals(tzStr)) ? null : tzStr,
                    f, lenient);
        }

        public Value(String p, Shape sh, Locale l, Features f,
                Boolean lenient) {
            _pattern = p;
        ...
        public Value(String p, Shape sh, Locale l, String tzStr, Features f,
                Boolean lenient) {
            _pattern = p;
            _shape = (sh == null) ? Shape.ANY : sh;
            _locale = l;
        ...
        public final Value withOverrides(Value overrides) {
            ...
            return new Value(p, sh, l, tzStr, f, lenient);
        }

        public static Value forPattern(String p) {
            return new Value(p, null, (String) null, null, Features.empty(), null);
        }

        public static Value forShape(Shape sh) {
            return new Value(null, sh, (String) null, null, Features.empty(), null);
        }

        public static Value forLeniency(boolean lenient) {
            return new Value(null, null, (String) null, null, Features.empty(),
                    Boolean.valueOf(lenient));
        }

        public Value withPattern(String p) {
            return new Value(p, _shape, _locale, _timezoneStr,
                    _features, _lenient);
        }
        ...
        public Value withShape(Shape s) {
            ...
            return new Value(_pattern, s, _locale, _timezoneStr,
                    _features, _lenient);
        }

        public Value withLocale(Locale l) {
            return new Value(_pattern, _shape, l, _timezoneStr,
                    _features, _lenient);
        }
        ...
        public Value withLenient(Boolean lenient) {
            ...
            return new Value(_pattern, _shape, _locale, _timezoneStr,
                    _features, lenient);
        }

        public Value withFeature(JsonFormat.Feature f) {
            Features newFeats = _features.with(f);
            return (newFeats == _features) ? this : new Value(_pattern, _shape, _locale, _timezoneStr,
                    newFeats, _lenient);
        }
