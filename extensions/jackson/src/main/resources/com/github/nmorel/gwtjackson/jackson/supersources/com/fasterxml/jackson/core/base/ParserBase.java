...
public abstract class ParserBase extends ParserMinimalBase {
    ...
    protected void _handleEOF() throws JsonParseException {
        if (!_parsingContext.inRoot()) {
            ...
            _reportInvalidEOF(StringUtil.format(
    ...
    protected void _reportMismatchedEndMarker(int actCh, char expCh) throws JsonParseException {
        ...
        _reportError("Unexpected close marker '" + ((char) actCh) + "': expected '" + expCh + "' (for "
                + _parsingContext.typeDesc() + " starting at " + startDesc + ")");
    }
    ...
    protected void reportOverflowInt() throws IOException {
        _reportError(StringUtil.format("Numeric value (%s) out of range of int (%d - %s)",
                getText(), Integer.MIN_VALUE, Integer.MAX_VALUE));
    }

    protected void reportOverflowLong() throws IOException {
        _reportError(StringUtil.format("Numeric value (%s) out of range of long (%d - %s)",
    ...
    protected IllegalArgumentException reportInvalidBase64Char(Base64Variant b64variant, int ch, int bindex, String msg)
        ...
        } else if (!CharacterUtil.isDefined(ch) || CharacterUtil.isISOControl(ch)) {
