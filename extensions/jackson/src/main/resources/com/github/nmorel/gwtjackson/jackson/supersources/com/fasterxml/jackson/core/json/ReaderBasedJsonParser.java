...
import com.github.nmorel.gwtjackson.jackson.client.util.CharacterUtil;
...
public class ReaderBasedJsonParser // final in 2.3, earlier
    ...
    public byte[] getBinaryValue(Base64Variant b64variant) throws IOException {
        ...
        if (_tokenIncomplete) {
            try {
                ...
                throw _constructError("Failed to decode VALUE_STRING as base64 (" + b64variant + "): " + iae
                        .getMessage());
            }
            ...
            if (bits < 0) {
                ...
                if (bits == Base64Variant.BASE64_VALUE_PADDING) {
                    ...
                    if (!b64variant.usesPaddingChar(ch)) {
                        throw reportInvalidBase64Char(b64variant, ch, 3, "expected padding character '" + b64variant
                                .getPaddingChar() + "'");
                    }
    ...
    protected String _handleOddName(int i) throws IOException {
        ...
        if (i < maxCode) { // identifier, or a number ([Issue#102])
            ...
            firstOk = CharacterUtil.isJavaIdentifierPart((char) i);
        }
        if (!firstOk) {
        ...
        if (ptr < inputLen) {
            do {
                ...
                } else if (!CharacterUtil.isJavaIdentifierPart((char) ch)) {
                    int start = _inputPtr - 1; // -1 to bring back first char
                    _inputPtr = ptr;
                    return _symbols.findSymbol(_inputBuffer, start, ptr - start, hash);
                }
    ...
    protected JsonToken _handleOddValue(int i) throws IOException {
        ...
        if (CharacterUtil.isJavaIdentifierStart(i)) {
    ...
    private String _handleOddName2(int startPtr, int hash, int[] codes) throws IOException {
        ...
        while (true) {
            ...
            } else if (!CharacterUtil.isJavaIdentifierPart(c)) {
                break;
            }
            ++_inputPtr;
